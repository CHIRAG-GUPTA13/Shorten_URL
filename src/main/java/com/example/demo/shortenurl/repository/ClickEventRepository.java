...
public interface ClickEventRepository extends JpaRepository<ClickEvent, Long> {
    ...
    /**
     * Find top performing URLs by click count for a specific user.
     * Returns short codes with their click counts, ordered by clicks descending.
     * 
     * @param shortCodes List of short codes to analyze
     * @param limit      Maximum number of results to return
     * @return List of objects containing shortCode and clickCount
     */
    @Query("SELECT c.shortCode, COUNT(c) FROM ClickEvent c WHERE c.shortCode IN :shortCodes GROUP BY c.shortCode ORDER BY COUNT(c) DESC")
    List<Object[]> findTopPerformingByShortCodes(@Param("shortCodes") List<String> shortCodes,
